...
def greedy_algorithm(snapshots,snapshotCorrelationOperator, NumberOfModes):
    """
...
def GreedyNew(snapshots,snapshotCorrelationOperator,GlobalIndex,h1ScalarProducMatrix=None,NumberOfModes=0,Tol=1e-30): ##create a RB from a priori given parameters
